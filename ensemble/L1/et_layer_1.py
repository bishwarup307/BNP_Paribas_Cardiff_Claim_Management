# -*- coding: utf-8 -*-
"""
Created on Sun Mar 20 23:50:58 2016
...
if __name__ == '__main__':
    ...
    for i in xrange(4):
        ...
        for j in xrange(fold_ids.shape[1]):
            ...
            del et, trainingSet, validationSet, ll, df
        ...
        et.fit(train[feature_names], train["target"])
        ...
        del eval_matrix, test_matrix, train, test, feature_names, train_file, test_file, et
